...
export const MCP_TOOLS: McpTool[] = [
  ...
  },
  {
    ...
    purpose: "Fetch machine-readable UploadCheck pipeline profiles and repair-loop contracts for NTO/NPO and creator workflows.",
    inputs: [],
  ...
  },
  {
    ...
    outputs: ["margin_safe", "effective_checks", "removed_checks", "cost_estimate", "action"]
  },
  {
    name: "qc_run_video",
