export function buildLaunchStatus(readiness, {
  ...
  return {
    ...
    public_artifacts: {
      ...
      mcp_install: "https://api.uploadcheck.app/mcp-install.json",
      launch_targets: "https://api.uploadcheck.app/launch-targets.json",
      cost_basis: "https://api.uploadcheck.app/cost-basis.json",
      sample_reports: "https://api.uploadcheck.app/sample-reports/index.json",
      product_hunt_launch_kit: "https://api.uploadcheck.app/product-hunt-launch-kit.json",
      launch_status: "https://api.uploadcheck.app/launch-status.json",
      live_launch_status: "https://api.uploadcheck.app/v1/launch-status",
      live_launch_handoff: "https://api.uploadcheck.app/v1/launch-handoff",
...
function verifiedControls() {
  return [
    ...
    },
    {
      id: "queued_worker",
      status: "done",
      evidence: "POST /v1/qc/jobs supports process_async=true and POST /v1/qc/jobs/drain processes queued jobs for Render worker/cron execution."
    },
    {
      id: "package_verify",
      status: "done",
    ...
    },
    {
      ...
      status: "done",
      evidence: "npm run mcp-install:verify checks the hosted MCP install artifact, Codex/Claude/Cursor install shapes, and workspace API-key placeholder."
    },
    {
